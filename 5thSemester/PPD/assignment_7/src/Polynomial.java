...
public class Polynomial implements Serializable {
    ...
    public String toString() {
        if (coefficients.isEmpty()) {
            return "No terms in this polynomial.";
        }
    ...
    public Polynomial padToSize(int size) {
    ...
    public Polynomial getLowPart(int m) {
        return new Polynomial(coefficients.subList(0, m));
    }

    public Polynomial getHighPart(int m) {
        return new Polynomial(coefficients.subList(m, coefficients.size()));
    }

    public Polynomial shift(int positions) {
        List<Integer> shifted = new ArrayList<>(Collections.nCopies(positions, 0));
        shifted.addAll(coefficients);
        return new Polynomial(shifted);
    }
