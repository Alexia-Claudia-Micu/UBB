...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = PlantAdapter(
            onDeleteClick = { plantId -> showDeleteConfirmationDialog(plantId) },
            onItemClick = { plantId ->
    ...
    private fun showDeleteConfirmationDialog(plantId: String) {
        ...
        dialogBuilder.setMessage("Are you sure you want to delete this plant?")
            .setCancelable(false)
            .setPositiveButton("Yes") { _, _ ->
                // If the user confirms, delete the plant
