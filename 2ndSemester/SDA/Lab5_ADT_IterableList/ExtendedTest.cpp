...
void testLastIndex(){
    cout<<"Test last index - LAB REQUIREMENT !!!\n";
    SortedIndexedList list = SortedIndexedList(asc);
    assert(list.lastIndexOf(1) == -1); // test before existing

    list.add(3);
    assert(list.lastIndexOf(3) == 0); // test unique
    list.add(3);
    assert(list.lastIndexOf(3) == 1); // test not unique
    list.add(0);
    list.add(5);
    assert(list.lastIndexOf(3) == 2); // test has neighbours
    list.add(3);
    list.add(3);
    assert(list.lastIndexOf(3) == 4); // test indexes are separated
    list.add(2);
    list.add(1);
    list.add(2);
    assert(list.lastIndexOf(3) == 7);
    list.add(7);
    list.add(8);
    assert(list.lastIndexOf(3) == 7);
}
