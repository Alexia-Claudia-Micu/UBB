    ...
    def menu(self):
        ...
        while command != "0":
            try:
                ...
                print("4. Print components using a depth first algorithm.")
                ...
                if command == "1":
                    ...
                    components = self._service.depth_first_components()
                    for key in components.keys():
                        print(f"Component {str(key)}: contains vertices {str(components[key])}")
                elif command == "6.a":
                    u = self._read_integer("first vertex")
                    v = self._read_integer("second vertex")
                    ...
                    self._service.modify_cost(u, v, new_cost)
                elif command =="7.1.a":
